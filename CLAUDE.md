...
| `tests/fixtures/programs/` | two REAL Del Mar program PDFs, each with an audited golden: 2026-08-30 (12.2MB, committed — same precedent as life-swipe's SSA archive) and 2026-08-22 (12.7MB; Pacific Classic day, a layout with no panel payoff box and stakes titles without the word "Stakes"; user decision 2026-09-02). Known gap pinned by check-program: R9 #9 Kensington Lane's trainer is glued into the owner field. |
