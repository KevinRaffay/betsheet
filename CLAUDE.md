...
npm run check-gh-api   # D217: gh-api.js's ALLOWLIST, offline and credential-free - what PATCH may reach and (mostly) what it must not, that the only PATCH body in the file is the literal {state:'closed'}, and that DELETE is permitted nowhere
