...
| Card params in generate UI (D29) | in review | PR #18, branch `card-params-ui` — bankroll/per-race-min fields on the generate action; day = program, card = parameterized sheet |
