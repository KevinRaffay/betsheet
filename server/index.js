...
import { pickScoringRouter } from './pick-scoring.js';
import { tipStakingRouter } from './tip-staking.js';
import { combinedCardsRouter } from './combined-cards.js';
...
app.use('/api', pickScoringRouter);
app.use('/api', tipStakingRouter);
app.use('/api', combinedCardsRouter);
