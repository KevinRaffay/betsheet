...
//
// D139: this page's own `cardId` is purely a DISPLAY concern - which card's
// per-race status and "final card" it shows - and stays the simple "latest"
// rule (D60/D98). It is NOT threaded into DayTicketBuilderModal any more:
// D137 tried lifting card selection (including "start a new one" and its
// name) up into this page and ReplayRaceView, and that split card
// management across components that never needed to know a card id at all.
// D139 undoes that: the modal resolves and manages its own card identity,
// this page just refreshes (`refreshKey`) and re-reads "the latest" after
// the modal closes, the same way CardsPanel.jsx does for the live /day view.
//
