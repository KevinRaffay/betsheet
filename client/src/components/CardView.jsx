  ...
  return (
    <section className="card-sheet">
      ...
      <p className="dim">
        ...
        {' '}consensus · bankroll {money(card.bankroll_cents)} · per-race min {money(card.per_race_min_cents)}
            ...
            {raceTickets.length === 0
              ...
              : (
                <table className="grid">
                  ...
                  <tbody>
                    {raceTickets.map((t) => <TicketRow key={t.id} t={t} />)}
      ...
      {multis.length > 0 && (
        <div className="race race--sheet">
          ...
          <table className="grid">
            ...
            <tbody>
              {multis.map((t) => <TicketRow key={t.id} t={t} />)}
              <tr className="row--subtotal">
