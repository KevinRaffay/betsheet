...
| D03 | SQLite schema + migrations (full schema incl. Phase 2–4 tables) | 1 | `schema` | in review | better-sqlite3; append-only migrations w/ tamper guard; money in integer cents; `npm run check-schema` |
